...
import { View, Image, Text, TouchableOpacity, Linking, ScrollView, Platform } from "react-native";
...
const NeedHelp = () => (
    <SafeAreaViewParent>
        <ScrollView>
            <View style={{ backgroundColor: "#EEF7FF", height: "100%", alignItems: "center", paddingHorizontal: 20, paddingBottom: Platform.OS === "ios" ? 80 : 0 }}>
